...
Tony offers you one piece of advice as he walks out:
 "Just rewrite it. "
Congratulations, you're Tony now.
This repository exists because every organization eventually has to answer the same questions:
Do we keep depending on Tony...or do we build ourselves a bridge? 
How do we buy ourselves enough time to do this right?
It represents well over thousands of hours spent designing, migrating, validating, and troubleshooting enterprise virtualization platforms over the last 26 years.
...
One tiny mistake later...
	...
	•	Someone's "well-tested" automation faithfully destroys your infrastructure.
