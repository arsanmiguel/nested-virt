...
**Related:** [README](../README.md) · [Developer guide](BUILD.md) · [Deploy guide](DEPLOY-FROM-CFN.md)

## Next: Terraform port

The current lab is **drop-in CloudFormation** ([DEPLOY-FROM-CFN.md](DEPLOY-FROM-CFN.md)) for external operators and **bash + SSM + S3 bootstrap** for developers ([BUILD.md](BUILD.md)). Win2022.iso is fetched from Microsoft’s CDN at deploy time. Next milestone: Terraform without changing the proof model.
