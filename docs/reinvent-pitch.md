...
4. **It is repeatable.** Drop-in [`cloudformation/nested-virt-lab.yaml`](../cloudformation/nested-virt-lab.yaml) - upload to CloudFormation, wait for SSM GREEN, teardown.
