...
**Readable hero diagram (recommended):** [diagrams/end-to-end.png](diagrams/end-to-end.png) (click through to [diagrams/end-to-end.svg](diagrams/end-to-end.svg) for vector) — **locked baseline** used in [README](../README.md). After editing the SVG, run `./docs/diagrams/render-end-to-end.sh` so the PNG stays in sync.
